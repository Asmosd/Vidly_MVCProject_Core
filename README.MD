# ASP.NET MVC5 Project fork: Migrated to .NET 8.0

This was an MVC app developed with .NET Framework 4.8 for learning purposes. It has been migrated to .NET 8.0.
